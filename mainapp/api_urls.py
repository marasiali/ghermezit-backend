...
urlpatterns = [
    ...
    path('api/rest-auth/registration/phone/activate', views.ActivatePhonenumber.as_view()),
    path('api/rest-auth/registration/phone/send-activation-code', views.SendPhonenumberActivationCode.as_view()),
]
